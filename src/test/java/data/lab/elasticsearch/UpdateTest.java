...
import data.lab.elasticsearch.operation.update.EsIndexUpdate;
...
public class UpdateTest {
    ...
    @Test
    public void test1() {
        EsIndexUpdate es = new EsIndexUpdate("106.75.177.129", 61233, "testdata_extract_result_v-201808", "analysis_data");
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("zdr_clue", new String[]{"湘西", "test"});
