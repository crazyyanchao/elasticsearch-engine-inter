...
import data.lab.elasticsearch.operation.search.analyzer.AggsAnalyzer;
import data.lab.elasticsearch.util.DateUtil;
...
//    private String ipPort = "localhost:9200";
    ...
    // 预警：
    // http://192.168.12.109:9210/testnews_ref_monitor,testblog_ref_monitor,testthreads_ref_monitor,
    // testmblog_ref_monitor,testvideo_ref_monitor,testweichat_ref_monitor,testappdata_ref_monitor/monitor_data/_search
    ...
    public void searchObject() {
        ...
        String waring = "testnews_ref_monitor,testblog_ref_monitor,testthreads_ref_monitor,testmblog_ref_monitor," +
                "testvideo_ref_monitor,testweichat_ref_monitor,testappdata_ref_monitor";
...
//        esSmallIndexSearch.addArrayTypeTermsQuery("area_list", new String[]{"长春"}, FieldOccurs.MUST);
         ...
         * 执行 getCountTotal()方法               为条件过滤后执行聚合总量；
         */
        Map<String, Long> results = esSmallIndexSearch.facetCountQueryOrderByCountToMap("area_list", 0, SortOrder.DESC);
...
//        aircraftSearch.addQueryCondition("+destination:(*P*)");
    ...
    public void statsEventComment() {
        EsIndexSearch eventSearch = new EsIndexSearch(ipPort, "testmblog_info_ref_event", "testdata");
        int eid = 705;
...
//        EsIndexSearch esc = SearchIndexer.getSearchClient("user_mblog_info_ref_zdr,user_facebook_info_ref_zdr,user_wechat_info_ref_zdr,user_forum_threads_ref_zdr,user_blog_ref_zdr,user_instagram_thread_ref_zdr,user_youtube_info_ref_zdr,user_twitter_info_ref_zdr,user_linkedin_thread_ref_zdr", "zdr_data");
    ...
    public void searchByIdRange() {
        EsIndexSearch.debug = true;
        EsIndexSearch esc = new EsIndexSearch(ipPort, "testwechat_info_ref_monitor", "monitor_data");
    ...
    public void searchByIdRange3() {
        EsIndexSearch.debug = true;
        EsIndexSearch esc = new EsIndexSearch(ipPort, "testmblog_info_ref_monitor", "monitor_data");
        esc.addPrimitiveTermFilter("eid", "630", FieldOccurs.MUST);
        esc.addRangeTerms("id", "7331762", FieldOccurs.MUST, RangeOccurs.GTE);
        esc.addSortField("id", SortOrder.ASC);
        esc.setRow(10);
    ...
    public void searchByIdRange4() {
        ...
        EsIndexSearch.debug = true;
        long auto_id = -1;
        EsIndexSearch esIndexSearch = new EsIndexSearch(ipPort, "testmblog_info_ref_monitor", "monitor_data");
